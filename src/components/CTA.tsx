    ...
    <section id="cta" className="bg-gradient-to-r from-irides-green via-green-700 to-green-800 py-16 lg:py-24 text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg md:text-xl text-green-50 mb-8 max-w-3xl mx-auto">
          Let IRIDES bring your vision to life with exceptional quality, speed, and value. Our team is ready to help – contact us today for a personalized quote!
        </p>
        <a
          href="#quote-form" // Should link to the actual quote form/section later
